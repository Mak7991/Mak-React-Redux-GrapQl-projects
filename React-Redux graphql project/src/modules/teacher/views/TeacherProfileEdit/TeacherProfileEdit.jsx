...
import TeacherFormDesign from "modules/teacher/views/TeacherProfileEdit/TeacherFormDesign/TeacherFormDesign";
import {
  getCurrentUserData,
  getUpdateUserData,
...
class TeacherProfileEdit extends PureComponent {
  passwordRef = React.createRef();
  editTeacherData = React.createRef();
  ...
  updateStudentSocialLinks = (values) => {
    const links = this.props.editTeacher.curUser.socialLinks;
  ...
  componentDidUpdate(preProps) {
    if (
      this.props.editTeacher.uiStateUpdatingStudent === SUCCESS &&
      this.props.editTeacher.uiStateUpdatingStudent !== preProps.editTeacher.uiStateUpdatingStudent
    ) {
      message.success("Student Data Updated");
      this.editTeacherData.current.setFieldsValue({
        ...this.props.editTeacher.curUser,
      });
    }
    if (
      this.props.editTeacher.uiStateUpdatingStudentPassword === SUCCESS &&
      this.props.editTeacher.uiStateUpdatingStudentPassword !==
        preProps.editTeacher.uiStateUpdatingStudentPassword
    ) {
      message.success("Student Password Updated");
      this.passwordRef.current.setFieldsValue({
        password: this.props.editTeacher.curUser.password,
        newPassword: "",
        confirmPassword: "",
      });
    }
    if (
      this.props.editTeacher.uiStateUpdatingStudentSocial === SUCCESS &&
      this.props.editTeacher.uiStateUpdatingStudentSocial !==
        preProps.editTeacher.uiStateUpdatingStudentSocial
    ) {
      this.socialObj = this.props.editTeacher.curUser.socialLinks.reduce((obj, cur, index) => {
  ...
  render() {
    ...
    const { password } = this.props.editTeacher.curUser;
    ...
    return (
      <Async
        ...
        onSuccess={() => {
          return (
            <Container>
              <div className="teacher-profile-edit-wrapped">
                <TeacherFormDesign
                  title="Basic Information"
                  content="Edit your account details and settings.">
                  <div className="teacher-profile-form">
                    <Form
                      className="teacher-profile-form-setting"
                      layout="vertical"
                      name="edit_teacher_data"
                      ref={this.editTeacherData}
                      initialValues={this.props.editTeacher.curUser}
              ...
              <div className="teacher-profile-edit-wrapped">
                <TeacherFormDesign title="Update Your Password" content="Change your password">
                  <div className="teacher-profile-form">
                    <Form
                      className="teacher-profile-form-setting"
                      layout="vertical"
                      name="edit_teacher-password"
              ...
              <div className="teacher-profile-edit-wrapped">
                <TeacherFormDesign
                  name="edit_teacher-social-links"
                  ...
                  <div className="teacher-profile-form">
                    <Form
                      ...
                      name="edit-teacher-social-links">
                      <div className="grouped">
                        <div className="group-form">
                          <Form.Item
...
export default connect(mapStateToProps, mapDispatchToProps)(TeacherProfileEdit);
